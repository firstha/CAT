                        ...
                        <table class="table mb-0">
                            ...
                            <tbody>
                                <tr v-for="(voucher, index) in vouchers.data" :key="index">
                                    ...
                                    <td>{{ voucher.code }}</td>
                                    <td>{{ voucher.name }}</td>
                                    <td>{{ voucher.active_period }} {{ voucher.type }}</td>
                                    <td>{{ formatPrice(voucher.price_before_discount) }}</td>
                                    ...
                                    <td>
                                        <div class="d-flex order-actions">
                                            <Link :href="`/admin/vouchers/${voucher.id}/edit`" class="ms-2"><i class='bx bxs-edit'></i></Link>
                                            <a href="#" @click.prevent="destroy(voucher.id)" class="ms-2"><i class="bx bxs-trash"></i></a>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
