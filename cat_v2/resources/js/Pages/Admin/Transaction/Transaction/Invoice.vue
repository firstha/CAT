<template>
    <Head>
        <title>{{ $page.props.setting.app_name ?? 'Atur Setting Terlebih Dahulu' }} - Detail Faktur</title>
    </Head>
    <!--start page wrapper -->
				...
				<div class="ps-3">
					<nav aria-label="breadcrumb">
						<ol class="breadcrumb mb-0 p-0">
							...
							<li class="breadcrumb-item active" aria-current="page">Detail Faktur</li>
						</ol>
					</nav>
				</div>
			</div>
									...
									<table>
										...
										<tbody>
											<tr>
												<td class="no">01</td>
												<td class="text-left">
													<h3>{{ transaction.voucher_code }}</h3>{{ transaction.voucher_name }}</td>
												<td class="unit">{{ formatPrice(transaction.voucher_price_before_discount)  }}</td>
												<td class="qty">{{ formatPrice(transaction.voucher_nominal_discount)  }}</td>
