                            ...
                            <table class="table mb-0">
                                <tbody>
                                    ...
                                    <tr>
                                        <td>Nama Voucher</td>
                                        <td>:</td>
                                        <td>{{ transaction.voucher_name }}</td>
                                    </tr>
                                    <tr>
                                        <td>Periode Voucher</td>
                                        <td>:</td>
                                        <td>{{ transaction.voucher_active_period }} {{ transaction.voucher_type }}</td>
                                    </tr>
                                    <tr>
                                        <td>Harga</td>
                                        <td>:</td>
                                        <td>{{ formatPrice(transaction.voucher_price_before_discount) }}</td>
                                    </tr>
                                    <tr>
                                        <td>Diskon</td>
                                        <td>:</td>
                                        <td>{{ formatPrice(transaction.voucher_nominal_discount) }}</td>
                                    </tr>
                                    <tr>
