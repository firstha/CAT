                                ...
                                <tr v-for="(exam, index) in examGroups.data" :key="index">
                                    ...
                                    <td>
                                        <div class="d-flex order-actions">
                                            <Link :href="`/admin/exam-groups/${exam.id}/students`" class="ms-2"><i class='bx bx-user'></i></Link>
                                            <Link :href="`/admin/exam-groups/${exam.id}/exam-group-details`" class="ms-2"><i class='bx bx-grid-alt'></i></Link>
