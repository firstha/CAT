        ...
        <div class="page-content">
            ...
            <div class="card border-top border-0 border-3 border-primary">
                <div class="card-body">
                    <div class="d-lg-flex align-items-center mb-4 gap-3">
                        <div class="ms-auto">
                            <Link :href="`/admin/exam-groups/${examGroup.id}/exam-group-details/create`" class="btn btn-primary btn-sm mt-2 mt-lg-0"><i class="bx bxs-plus-square"></i> Tambah Try Out</Link>
                        </div>
                    </div>
