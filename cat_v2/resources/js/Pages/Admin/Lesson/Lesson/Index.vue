                                ...
                                <tr v-for="(lesson, index) in lessons.data" :key="index">
                                    ...
                                    <td>
                                        <div class="d-flex order-actions">
                                            <Link :href="`/admin/lessons/${lesson.id}/edit`" class="ms-2"><i class='bx bxs-edit'></i></Link>
                                            <a href="#" @click.prevent="destroy(lesson.id)" class="ms-2"><i class="bx bxs-trash"></i></a>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
