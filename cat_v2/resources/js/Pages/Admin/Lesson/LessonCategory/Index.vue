                            ...
                            <tr v-for="(lessonCategory, index) in lessonCategories.data" :key="index">
                                ...
                                <td>
                                    <div class="d-flex order-actions">
                                        <Link :href="`/admin/lesson-categories/${lessonCategory.id}/edit`" class="ms-2"><i class='bx bxs-edit'></i></Link>
                                        <a href="#" @click.prevent="destroy(lessonCategory.id)" class="ms-2"><i class="bx bxs-trash"></i></a>
                                    </div>
                                </td>
                            </tr>
                            <tr>
