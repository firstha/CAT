                                ...
                                <tr v-for="(questionTitle, index) in questionTitles.data" :key="index">
                                    ...
                                    <td>
                                        <div class="text-center">
                                            <span class="badge bg-success">{{ questionTitle.add_value_category == 0 ? 'Tidak' : 'Ya' }}</span>
                                    ...
                                    <td>
                                        <div class="d-flex order-actions">
                                            ...
                                            <a href="#" @click.prevent="resetStatus(questionTitle.id)" class="ms-2 text-warning" title="Reset Status Ujian">
...
<script>
    ...
    Swal.fire({
        ...
        text: 'Semua status ujian untuk paket soal ini akan diubah menjadi "active". Lanjutkan?',
        icon: 'question',
        showCancelButton: true,
        confirmButtonColor: '#3085d6',
        cancelButtonColor: '#d33',
        ...
        if (result.isConfirmed) {
            Inertia.post(`/admin/question-titles/${id}/reset-status`, {}, {
                onSuccess: () => {
                    Swal.fire({
                        title: 'Berhasil!',
                        text: 'Status ujian berhasil di-reset.',
                        icon: 'success',
                        timer: 1500,
                        showConfirmButton: false,
                    });
                ...
                onError: (errors) => {
                    Swal.fire({
                        title: 'Gagal!',
                        text: 'Terjadi kesalahan saat mereset status.',
                        icon: 'error',
                    });
                }
            });
