                                ...
                                <tr v-for="(subCategory, index) in subCategories.data" :key="index">
                                    ...
                                    <td>
                                        <div class="d-flex order-actions">
                                            <Link :href="`/admin/sub-categories/${subCategory.id}/edit`" class="ms-2"><i class='bx bxs-edit'></i></Link>
                                            <a href="#" @click.prevent="destroy(subCategory.id)" class="ms-2"><i class="bx bxs-trash"></i></a>
                                        </div>
                                    </td>
                                </tr>
