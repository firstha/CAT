                    ...
                    <div class="card border-bottom border-3 border-0">
                        ...
                        <div class="card-body">
                            ...
                            <div class="text-center">
                                <Link :href="`/user/categories/${lessonCategory.category_id}/lesson-categories/${lessonCategory.id}/lessons`" class="btn btn-outline-primary btn-sm">Selengkapnya</Link>
                            </div>
                        </div>
                    </div>
                </div>
