<template>
    ...
    <div class="page-wrapper">
        <div class="page-content">
            <div class="alert alert-primary border-0 bg-primary alert-dismissible fade show py-2" v-if="totalTransactionDone == 0 && $page.props.setting.add_voucher_purchase == 1 && $page.props.auth.user.member_type == 2">
                <div class="d-flex align-items-center">
                    ...
                    <div class="ms-3">
                        ...
                        <div class="text-white">Sebelum mengikuti try out, silakan lakukan transaksi voucher terlebih dahulu ya, agar kamu dapat mengikuti berbagai macam jenis tes yang tersedia.</div>
                    </div>
                </div>
            </div>

            <div class="row" v-if="totalTransactionDone == 0 && $page.props.setting.add_voucher_purchase == 1 && $page.props.auth.user.member_type == 2">
                <div class="col-lg-6 col-md-12 col-sm-12" v-for="category in $page.props.voucherCategories">
                    <div class="card">
                        <div class="row g-0">
                            ...
                            <div class="col-md-7">
                                <div class="card-body">
                                    <h5 class="card-title">Voucher Try Out {{ category.name }}</h5>
                                    <p class="card-text">Voucher Try Out {{ category.name }} merupakan akses untuk mengikuti berbagai jenis try out yang ada di dalam kategori tes {{ category.name }}.</p>
                                    <Link :href="`/user/vouchers?category_id=${category.id}`" class="btn btn-primary btn-sm btn-block">Lihat Detail Vouher</Link>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="card radius-10 border-start border-0 border-3 border-danger" v-if="transactionSummaries.length > 0">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div>
                        ...
                        <table class="table align-middle mb-0">
                            ...
                            <tbody>
                                ...
                                <tr v-for="(transactionSummary, index) in transactionSummaries" :key="index">
                                    ...
                                    <td>{{ transactionSummary.voucher_name }}</td>
                                    <td>{{ transactionSummary.voucher_active_period }} {{ transactionSummary.voucher_type }}</td>
                                    <td>
